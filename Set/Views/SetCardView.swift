            ...
            ZStack {
                ...
                if card.isSelected {
                    if let match = card.isMatched {
                        if match {
                            shape.strokeBorder(DrawingConstants.matchColor, lineWidth: DrawingConstants.borderWidth)
                        }
                        else {
                            shape.strokeBorder(DrawingConstants.mismatchedColor, lineWidth: DrawingConstants.borderWidth)
                        }
                    }
                    else {
